...
export default function BookingActionBar({
  ...
  return (
    <footer className="fixed inset-x-0 bottom-0 z-40 border-t border-bg-border bg-bg-white/95 px-3 py-2.5 shadow-[0_-16px_40px_rgba(15,23,42,.10)] backdrop-blur sm:sticky sm:bottom-4 sm:rounded-2xl sm:border sm:px-4 sm:py-3">
