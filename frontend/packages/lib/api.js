...
export const normalizeBooking = (booking = {}) => {
  ...
  return {
    ...
    baseGrandTotal: Number(booking.baseGrandTotal ?? breakdown.baseGrandTotal ?? pricing.totalAmount ?? 0),
    rateAdjustmentAmount: Number(booking.rateAdjustmentAmount ?? breakdown.rateAdjustmentAmount ?? 0),
    rateAdjustment: booking.rateAdjustment ?? breakdown.rateAdjustment ?? null,
