...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      borderRadius: {
        sm: "var(--radius-sm)", md: "var(--radius-md)", lg: "var(--radius-lg)", xl: "var(--radius-xl)", '2xl': "var(--radius-2xl)",
      },
      ...
      backgroundImage: {
        'sky-gradient': 'linear-gradient(135deg, #0EA5E9 0%, #38BDF8 100%)', 'sky-gradient-soft': 'linear-gradient(135deg, #E0F2FE 0%, #BAE6FD 100%)', 'orange-gradient': 'linear-gradient(135deg, #0EA5E9 0%, #38BDF8 100%)', 'hero-gradient': 'var(--color-bg-hero)', 'section-gradient': 'var(--color-bg-section-grad)', 'card-gradient': 'var(--color-bg-card-grad)',
      },
    },
  },
  plugins: [],
