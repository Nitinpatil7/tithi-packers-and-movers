...
export default function Navbar({ minimal = false }) {
  ...
  const services = [
    ...
    { name: serviceLabels.porter_labour_service || t.labourService || 'Labour & Vehicle', path: '/book/labour-service', color: '#38BDF8', desc: t.labourServiceDesc || 'Labour with optional vehicle' },
  ];
