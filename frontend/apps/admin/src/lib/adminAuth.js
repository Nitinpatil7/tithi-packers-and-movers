...
export const requestAdminPasswordReset = (email) => adminRequest('/password-reset/request', {
  method: 'POST',
  body: JSON.stringify({ email }),
});
export const verifyAdminPasswordResetOtp = (email, otp) => adminRequest('/password-reset/verify', {
  method: 'POST',
  body: JSON.stringify({ email, otp }),
});
export const completeAdminPasswordReset = (email, verificationId, newPassword) => adminRequest('/password-reset/complete', {
  method: 'POST',
  body: JSON.stringify({ email, verificationId, newPassword }),
});
