...
export default function TestimonialsSection() {
  ...
  return <section className="dotted-light-bg relative overflow-hidden py-20 md:py-32"><div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-bg-border to-transparent" /><Image src="/back_truck.png" alt="" width={360} height={240} className="pointer-events-none absolute -left-24 top-8 z-0 w-[180px] opacity-80 drop-shadow-[0_22px_34px_rgba(15,23,42,.18)] sm:-left-28 sm:w-[240px] md:w-[300px] lg:w-[360px]" /><div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
