...
export default function TestimonialsSection() {
  ...
  return <section className="dotted-light-bg relative overflow-hidden py-20 md:py-32"><div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-bg-border to-transparent" /><Image src="/back_truck.png" alt="" width={360} height={240} className="pointer-events-none absolute -left-28 bottom-4 z-0 hidden w-[280px] opacity-95 drop-shadow-[0_22px_34px_rgba(15,23,42,.22)] md:block lg:w-[360px]" /><div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
