...
export default function TestimonialsSection() {
  ...
  return <section className="dotted-light-bg relative overflow-hidden py-20 md:py-32"><div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-bg-border to-transparent" /><Image src="/back_truck.png" alt="" width={560} height={370} className="pointer-events-none absolute -left-32 top-28 z-0 w-[300px] opacity-35 drop-shadow-[0_22px_34px_rgba(15,23,42,.16)] sm:-left-40 sm:top-24 sm:w-[380px] md:top-16 md:w-[460px] md:opacity-55 lg:-left-44 lg:w-[560px] lg:opacity-80" /><div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
