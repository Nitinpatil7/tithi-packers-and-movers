...
export default function TestimonialsSection() {
  ...
  return <section className="dotted-light-bg relative overflow-hidden py-20 md:py-32"><div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-bg-border to-transparent" /><Image src="/back_truck.png" alt="" width={420} height={280} className="pointer-events-none absolute -left-28 top-6 z-0 w-[220px] opacity-85 drop-shadow-[0_22px_34px_rgba(15,23,42,.18)] sm:-left-32 sm:w-[280px] md:w-[340px] lg:w-[420px]" /><div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
